...
static bool itr_Debounce(){
  ...
  bool valid_time = current_time - LAST_TIME > 200000; // Verifica se passaram pelo menos 200ms desde a última interrupção
...
// Define a função de callback que será chamada quando ocorrer a interrupção
